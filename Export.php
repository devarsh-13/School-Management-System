...
$details=["Sr no.","Gr no.","UID no.","Name","Class","Stream","Caste","Category","DOB","Admission date","Contact no.","Adhar no.","Home Address","Hostel Address","Handicapped","Describe","Remarks"];
...
$query = $Conn->query("SELECT * FROM `Students` ORDER BY S_srn");
