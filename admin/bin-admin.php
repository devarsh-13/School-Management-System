...
if (isset($_GET['a_id']))
{
    ...
    $query = "UPDATE `admin` SET `is_deleted`='0' WHERE `A_id`='$aid'";
...
<html lang="en">
    <head>
      <title>Restore Admin data | IGHS</title>
            ...
            <div class="header-area">
                <div class="row align-items-center" >
                    <ul class="breadcrumbs pull-left">
                          <h4 class="page-title pull-left">Restore Admin </h4>
                                <li><a href="dashboard.php">Home</a></li>
                                
                                <li><span>Restore Admin data</span></li>
...
if($row > 0)
{
    ...
    {       ?>
                    <tr align="center">
                        ...
                        <td>  <a href="bin-admin.php?a_id=<?php echo $obj->encrypt($result['A_id']);?>">
